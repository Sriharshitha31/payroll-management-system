...
<!-- !PAGE CONTENT! -->
  ...
  <!-- Header -->
      ...
      <div class="w3-display-container w3-text-white" style="font-size: 130px">
          <img src="images/main.jpg" alt="Lights" style="width:100%" style="height: 50px">
          <div class="w3-display-middle w3-large" > <h1 style="font-family:Algerian;font-size:40px;text-shadow:2px 2px orange"><b>Welcome to Payroll system</b></h1></div>
      </div>
  ...
  <pre>
                                                       ...
                                                       We are developing this site.</pre></div>
  ...
  <pre>
                      <b><i>Sri Harshitha Uppaala 19BCE0770</i></b> 
                      <b><i> Chama Jahnavi 19BCE0428 </i></b></pre></div>
