...
<!-- !PAGE CONTENT! -->
  ...
  <!-- Header -->
      ...
      <div class="w3-display-container " style="font-size: 50px;color:#f5f5dc">
          <img src="images/hes.jpg" alt="Lights" style="width:100%" style="height: 150px">
          <div class="w3-display-middle w3-large" > <h1 style="font-family:Time New Roman;font-size:50px;text-shadow:1px 1px orange"><b>Pay Slip Show</b></h1></div>
      </div>
   <div class="w3-container">
      <h4>Employee Data</h4>
       <table>
       ...
       <button onClick='window.print()'class="btn btn-primary" style="background-color:green;color:white">Print pay slip</button>
      </div>
...
<!-- W3.CSS Container -->
    <div class="w3-dark-grey w3-container w3-padding-32" style="margin-top:75px;padding-right:58px"><p class="w3-right"> </a></p></div>
